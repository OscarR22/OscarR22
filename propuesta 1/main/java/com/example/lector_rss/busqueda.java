...
public class busqueda extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button busquedaN=vista.findViewById(R.id.busquedaN);
        Button favorites=vista.findViewById(R.id.favoritesD);


        busquedaN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findNavController(v).navigate(R.id.noticia_busqueda);
